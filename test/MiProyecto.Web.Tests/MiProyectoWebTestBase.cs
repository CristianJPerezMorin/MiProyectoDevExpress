...
{
    public abstract class MiProyectoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MiProyectoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MiProyectoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MiProyectoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MiProyectoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MiProyectoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MiProyectoDbContext, Task<T>> func)
        {
            T result;
